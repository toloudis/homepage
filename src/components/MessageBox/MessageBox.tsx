...
//TODO import emailjs from "emailjs-com";
...
const MessageBox = () => {
  const [sending, _setSending] = useState<boolean>(false);
  const [sendEmailSuccess, setSendEmailSuccess] = useState<boolean>(false);
  const SendEmail = (_object: Record<string, unknown>) => {
    alert("Contact form currently disabled - try the email link instead");
    //TODO
    // setSending(true);
